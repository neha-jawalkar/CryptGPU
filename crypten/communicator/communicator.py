...
def _logging(func):
    ...
    def logging_wrapper(self, *args, **kwargs):
        ...
        # only log if needed:
        if self.is_verbose():
            if func.__name__ == "recv" or func.__name__ == "irecv":
                pass 
            elif func.__name__ == 'send_obj' or func.__name__ == 'recv_obj':
                pass
            elif args[0].dtype == torch.uint8:
                self.BYTES_PER_ELEMENT = 1
            elif func.__name__ == "barrier":
